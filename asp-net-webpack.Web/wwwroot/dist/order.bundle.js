...
new Vue({
    ...
    methods: {
        fetchOrders: function () {
            ...
            return this.$apiService.Get("order", this.order.filter)
                .then(data => {
                    ...
                    this.$pagination.InfiniteScroll(this.$refs.orderTable, data, this.getNextPage);
                })
        ...
        saveOrder: function () {
            ...
            return this.$apiService.Post("order", this.order.details)
                .then(() => {
        ...
        orderBy: function (value) {
            this.order.filter = this.$orderByHandler.Handle(this.order.filter, value);
            this.filterChanged();
        },

        datetimeLong: function (item) {
            return this.$dayjs(item).format("DD.MM.YYYY HH:mm")
        }
    },
    computed: {
    ...
    watch: {
        'order.isLoading': function (value) {
            if (value) this.$loadHandler.AddTableLoader(this.$refs.orderTable);
            else this.$loadHandler.RemoveTableLoader(this.$refs.orderTable);
        }
    },
    mounted: function () {
        this.fetchOrders();

        this.order.modal = new bootstrap__WEBPACK_IMPORTED_MODULE_0__.Modal(this.$refs.orderModal);
    },
});
