...
/***/ "./wwwroot/js/handlers/feedback.js":
/*!*****************************************!*\
  !*** ./wwwroot/js/handlers/feedback.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function displayError(error, hideAfterMs = 0) {
    ...
    var modal = new bootstrap__WEBPACK_IMPORTED_MODULE_0__.Modal(document.getElementById('globalModal'));
    modal.show();
...
/* harmony import */ var _handlers_feedback__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../handlers/feedback */ "./wwwroot/js/handlers/feedback.js");
﻿
...
var GetRequest = function (throwError, url, data = {}) {
    return new Promise((resolve, reject) => {
        http.get(url, {
            ...
            if (throwError)
                _handlers_feedback__WEBPACK_IMPORTED_MODULE_1__.default.DisplayError(err.response.data);
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var bootstrap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! bootstrap */ "./node_modules/bootstrap/dist/js/bootstrap.esm.js");
/* harmony import */ var services_apiService_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! services/apiService.js */ "./wwwroot/js/services/apiService.js");
...
if (signOutBtn) {
    signOutBtn.addEventListener("click", function () {
        services_apiService_js__WEBPACK_IMPORTED_MODULE_1__.default.Post("account/logout")
            .then(() => window.location.href = window.location.origin + "/Account/Login");
    })
}
...
document.querySelectorAll("#sidebar li>button~.collapse")
    .forEach(elm => new bootstrap__WEBPACK_IMPORTED_MODULE_0__.Collapse(elm, { toggle: false }).hide())
...
document.querySelectorAll("#sidebar .nav-link[href='" + window.location.pathname + "']")
    .forEach(function (elm) {
        ...
        if (collapseElem != null) new bootstrap__WEBPACK_IMPORTED_MODULE_0__.Collapse(collapseElem, { toggle: false }).show()
