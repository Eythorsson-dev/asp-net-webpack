...
using asp_net_webpack.Core.ExternalApi.ExtenalApiExample;
using asp_net_webpack.Core.Repository;
using asp_net_webpack.Core.Request.Integration;
using asp_net_webpack.Domain.Enum.Integration;
using asp_net_webpack.Domain.Model.Order;
using System;

namespace asp_net_webpack.Core.Service.Integration
{
